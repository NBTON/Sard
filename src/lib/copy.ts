...
export const copy: Copy = {
  ...
  chatEmptyHint: { ar: "مرحبًا بك في مساحة عمل سرد — اطرح سؤالًا تراثيًا أو اختر بداية مقترحة أدناه", en: "Welcome to the Sard workspace — ask a heritage question or pick a starter below" },
